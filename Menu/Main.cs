...
namespace BreezeV2.Menu
{
    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void CreateMenu()
        {
            ...
            UnityEngine.Object.Destroy(Versioninfo.GetComponent<Rigidbody>());
            Versioninfo.transform.parent = menu.transform;
            Versioninfo.transform.rotation = Quaternion.identity;
            Versioninfo.transform.localScale = new Vector3(0.09f, 0.5f,  0.15f);
            Versioninfo.transform.localPosition = new Vector3(0.5f, -0.03f, 0.4f);
            Versioninfo.GetComponent<Renderer>().material.color = buttonColors[0].colors[0].color;
            Versioninfo.AddComponent<Classes.Button>().relatedText = "Version Info";

            colorChanger = Versioninfo.AddComponent<ColorChanger>();
            ...
            text.font = currentFont;
            text.text = "Ver: " + PluginInfo.Version; //VERSIONTEXT
            text.fontSize = 3;
            text.color = textColors[0];
            text.alignment = TextAnchor.MiddleCenter;
            text.fontStyle = FontStyle.Bold;
            ...
            component.localPosition = Vector3.zero;
            component.sizeDelta = new Vector2(0.2f, 0.03f);
            component.localPosition = new Vector3(0.064f, 0.27f, 0.15f);
            component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
